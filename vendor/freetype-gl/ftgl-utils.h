...
#endif
        const char *
        FTGL_Error_String(unsigned int error_code);
...
#define FTGL_ERROR_END_LIST                                                                                                                                                                                           \
    FTGL_ERR_CAT(FTGL_ERR_PREFIX, Max)                                                                                                                                                                                \
    }                                                                                                                                                                                                                 \
    ;
...
#define FTGL_ERRORDEF_(e, v, s) FTGL_ERRORDEF(FTGL_ERR_CAT(FTGL_ERR_PREFIX, e), v + FTGL_ERR_BASE, s)
