...
namespace Vultr
{
	...
	void delete_index_buffer(IndexBuffer ibo) { glDeleteBuffers(1, &ibo); }

	void bind_index_buffer(IndexBuffer ibo) { glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ibo); }

	void unbind_index_buffer() { glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0); }
