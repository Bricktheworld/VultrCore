...
TEST(Buffer, Creation)
{
	{
		Buffer buffer(200);
		ASSERT_NE(buffer.storage, nullptr);
	...
	Buffer third_buffer;
	{
		...
		ASSERT_NE(second_buffer.storage, buffer.storage);
		ASSERT_NE(second_buffer.storage, nullptr);
		...
		ASSERT_NE(third_buffer.storage, second_buffer.storage);
		ASSERT_NE(third_buffer.storage, nullptr);
