...
#define __THREAD
     ...
     */
    typedef enum font_location_t : uint8_t
    {
        TEXTURE_FONT_FILE = 0,
        TEXTURE_FONT_MEMORY = 1
    } font_location_t;

    /**
     * Enum type for automatic open/close
     */
    typedef enum font_mode_t : uint8_t
    {
        MODE_AUTO_CLOSE = 0,
        MODE_GLYPHS_CLOSE = 1,
        MODE_FREE_CLOSE = 2,
...
/* same for harfbuzz */
     ...
     * @return A pointer on the glyph or 0 if the glyph is not loaded
     */
    texture_glyph_t *texture_font_find_glyph_gi(texture_font_t *self, uint32_t glyph_index);
